...
class DeleteAddressRequestModel {
  ...
  factory DeleteAddressRequestModel.fromJson(String str) =>
      DeleteAddressRequestModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory DeleteAddressRequestModel.fromMap(Map<String, dynamic> json) =>
      DeleteAddressRequestModel(
